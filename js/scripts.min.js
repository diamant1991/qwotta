...
$(function(){$(".burger span, .burger2 span").on("click",function(e){$(".burger nav, .burger2 nav").addClass("fadeInNav"),e.stopPropagation()}),$(".burger nav, .burger2 nav .close").on("click",function(e){$(".burger nav, .burger2 nav").removeClass("fadeInNav"),e.stopPropagation()}),$('[name="city"]').kladr({type:$.kladr.type.city}),$("#datepicker").datepicker($.extend({inline:!0,changeMonth:!0},$.datepicker.regional.ru)),$("#datepicker2").datepicker($.extend({inline:!0,changeMonth:!0},$.datepicker.regional.ru)),$("#datepicker3").datepicker($.extend({inline:!0,changeMonth:!0},$.datepicker.regional.ru)),$("#datepicker4").datepicker($.extend({inline:!0,changeMonth:!0},$.datepicker.regional.ru)),$(".carousel-city").owlCarousel({items:6,center:!0,loop:!0,margin:20,dots:!1,nav:!0,navText:[""],responsive:{0:{items:1},575:{items:2},925:{items:3},1200:{items:4}, 1600:{items: 5}, 1800:{items: 6}}}),$(".carousel-booking").owlCarousel({items:1,loop:!0,nav:!0,navText:["","<span></span>"]}),$(".carousel-booking2").owlCarousel({items:1,loop:!0,nav:!0,navText:["","<span></span>"]}),$(".carousel-choice").owlCarousel({items:1,loop:!0,nav:!0,navText:["<span></span>","<span></span>"]})}),function(e){e(function(){e("ul.tabs__caption").on("click","li:not(.active)",function(){e(this).addClass("active").siblings().removeClass("active").closest("div.tabs").find("div.tabs__content").removeClass("active").eq(e(this).index()).addClass("active")})})}(jQuery);